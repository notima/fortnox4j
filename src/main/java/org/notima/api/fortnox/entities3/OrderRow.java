...
public class OrderRow {
    ...
    private Double	houseWorkHoursToReport;
	...
	@XmlElement(name="HouseWorkHoursToReport")
	public Double getHouseWorkHoursToReport() {
		return houseWorkHoursToReport;
	}
	public void setHouseWorkHoursToReport(Double houseWorkHoursToReport) {
